...
const HEADER_ALIASES = {
  ...
  useremail: ['useremail', 'email', 'owner'],
  duedate: ['due', 'targetdate'],
  due: ['duedate', 'targetdate'],
  targetdate: ['duedate', 'due'],
  lastupdateat: ['updatedat'],
  lastupdatesummary: ['description', 'notes'],
  accountid: ['accountid', 'tamunitid'],
  accountname: ['accountname', 'tamunitname'],
  projectid: ['projectid'],
